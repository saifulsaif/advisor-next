          ...
          <div className="container">
            ...
            <div className=" navbar-collapse" id="navbarText">
              <ul className="navbar-nav d-flex me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <Link className="nav-link text-white " href="/berater">
                    Alle Berater
                  </Link>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                  <Link className="nav-link text-white " href="/magazin">
                    Magazin
                  </Link>
                </li>
                <li className="nav-item">
              ...
              <div className="navbar-button d-flex gap-3 flex-wrap">
                <Link
                  className="nav-link register text-white secondary-button"
                  href="/registration"
                >
                  Registrieren
                </Link>
                <Link
                  className="nav-link login text-white primary-button"
                  href="/login"
                >
                  Login
                </Link>
